...
class ExperienceLayout extends Component {
    ...
    handleExperienceUpload = async () => {
        ...
        let response = await fetch("https://striveschool.herokuapp.com/api/profile/user5/experiences/" + this.state.id + "/picture", {
            method: "POST",
            body: photo,
            headers: new Headers({
    ...
    render() {
        return (
            <div className="d-flex flex-row">
                <img className="profilePicture mx-1" src={this.props.image || '/logo192.png'} alt="Profile pic" />
